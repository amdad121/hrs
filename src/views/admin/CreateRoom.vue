...
const storeRoom = () => {
	room.value.photo = photoFile.value
	roomStore.storeRoom(room.value)
}
</script>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="flex items-center gap-2 relative">
							...
							<div v-show="photoURL">
								<img :src="photoURL" :alt="room.name" class="w-auto h-10 rounded hover:absolute hover:h-auto hover:top-0 hover:left-0 hover:right-0 hover:bottom-0">
							</div>
						</div>
					</div>
				</div>
